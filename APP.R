            ...
            fluidRow(
              tabBox(
                ...
                tabPanel(
                  ...
                  p(strong("Para el correcto funcionamiento de la app se deben seguir los siguientes pasos:")),
                    ...
                    En la esquina superior de la app se encuentra el link de acceso a la página web del Instituto Nacional de Estadística (INE), donde se encuentran disponibles las bases de datos de la encuesta.",style="text-align:justify;color:black;background-color:lavender;padding:15px;border-radius:10px"),
                    p("Una vez cargados los datos, se debe seleccionar la sección y dentro de esta el indicador que se desea visualizar, contando con distintos tipos de gráficos y con una tabla con los resultados de las estimaciones puntuales. En el caso del gráfico de mapa, en la mayoría de los indicadores, se debe seleccionar la categoría a visualizar.
                    
                    Además de las estimaciones puntuales para los indicadores, se encuentran los resultados de los intervalos de confianza al 95% para las estimaciones.", strong(" Cabe aclarar que, de no estar utilizando la información sobre los estratos y las unidades primarias de muestreo, no se debe tener en cuenta los resultados de los intervalos de confianza ya que son incorrectos."), " Esto se debe a que la información sobre el diseño muestral es fundamental para el cálculo de los errores estándar de las estimaciones y con ello de los intervalos de confianza. Todas las tablas pueden ser descargadas en formato csv con el botón de descarga que tienen abajo de cada una, mientras los gráficos se pueden descargar en formato png.",style="text-align:justify;color:black;background-color:lavender;padding:15px;border-radius:10px"),
                  p("En la siguiente pestaña de esta sección, se encuentra el listado de variables de la ECH utilizadas en la app. Estas variables son fundamentales para el correcto funcionamiento de la aplicación, por lo que en caso de utilizar los datos de la encuesta para un año distinto a 2019, se debe verificar que estas variables no hayan sufrido cambios. En caso de que alguna de las variables haya cambiado de nombre en la base, se debe modificar el código de la app, o en su defecto modificar el nombre de la variable en la base de datos.",style="text-align:justify;color:black;background-color:lavender;padding:15px;border-radius:10px")
                ),
                tabPanel(
                  status= "success",
