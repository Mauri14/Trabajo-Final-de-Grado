...
Se observa que más de la mitad de los estratos (45 de los 82) tienen menos de 50 UPM, mientras los estratos que contienen mayor cantidad de UPM son los pertenecientes a Montevideo y al área metropolitana. 
...
\section{Dominios \label{sec:dom}}
...
El objetivo principal de una encuesta por muestreo es el obtener estimaciones de distintos parámetros de interés de la población sin observar toda la población, sino un subconjunto de esta, denominado muestra. Es decir, dada una población $U$ de tamaño $N$, se selecciona una muestra $s$ de tamaño $n$.
...
Los totales mencionados son desconocidos, por lo que serán estimados a partir de la muestra. Para ello se define el estimador de Horvitz-Thompson.
