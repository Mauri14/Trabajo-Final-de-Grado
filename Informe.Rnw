...
Buena parte de los resultados presentados en este trabajo fueron desarrollados en el marco del convenio entre IESTA y la Oficina de Planificación y Presupuesto (OPP), donde trabajé como integrante de equipo durante los años 2019 y 2020. Mis tareas consitieron principalmente en el cálculo de indicadores a partir de la encuesta continua de hogares, en este contexto fue notorio que contar con una herramienta como el monitor que se presenta en este trabajo simplifica mucho la tarea.
