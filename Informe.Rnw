...
Tanto $t$ como $R$, mencionados anteriormente, son desconocidos, por lo que serán estimados a partir de la muestra. Para ello se define el estimador de Horvitz-Thompson \citep{HT}.
