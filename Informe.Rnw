...
Buena parte de los resultados presentados en este trabajo fueron desarrollados en el marco del convenio entre IESTA y la Oficina de Planificación y Presupuesto (OPP), donde trabaje como integrante de equipo durante todo el año 2019. Mis tareas consitieron principalmente con el cálculo de indicadores a partir de la encuesta continua de hogares, en este contexto fue notorio que contar con una herramienta como el monitor que se presenta en este trabajo simplifica mucho la tarea.
...
La ECH cuenta con un diseño muestral aleatorio complejo, donde se incluyen estratos, conglomerados y se cuenta con varias etapas de selección. A continuación se realiza una breve descripción del mismo, la descripcion completa se puede encontrar en \cite{ine}, disponible en LINK.A.LA.IFCHA  
