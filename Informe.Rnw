...
Este estimador es insesgado para el total $t=\sum_{U}^{}y_i$. (CITAR SARNDAL POR LA DEMOSTRACIÓN). Por otra parte, el estimador de ratio o cociente $R$ entre dos variables queda definido:
