...
\includegraphics[width=0.20\textwidth]{udelar_logo.jpg}
...
Este estimador es insesgado para el total $t=\sum_{U}^{}y_i$. Por otra parte, el estimador de ratio o cociente $R$ entre dos variables queda definido:
...
En la práctica muchos usuarios que utilizan la bases de datos de encuestas públicas para realizar sus propias inferencias no siempre tienen en cuenta todas las fuentes de variabilidad que afectan al error estándar. Esto, puede derivar en la realización de inferencias inválidas sobre los parámetros de la población. Uno de los motivos por los cuales surge este problema es el no contar con los insumos necesarios en la bases de datos públicas de las encuestas sobre el diseño de muestreo. En el caso de la ECH, para los años anteriores a 2019 no se cuenta con la disponibilidad de información clave sobre el diseño muestral como los son las unidades primarias de muestreo (UPM) y los estratos.

Para un diseño complejo como el de la ECH, no existen métodos exactos para calcular los SE, lo que implica que se deba recurrir a distintas estrategias o métodos que aproximan de mejor forma la variabilidad de las estimaciones. Dentro de la amplia gama de métodos que existen se optó por el método del último conglomerado para computar los SE, que es el más usado en la práctica y se encuentra implementado en el paquete \textit{survey} del \textit{R}. Este método puede manejar tanto parámetros lineales como no lineales.
...
Al igual que para el caso de un total, el SE de la estimación de un ratio $R$ para un dominio $d$ se obtiene reemplazando en la ecuación las variables $y$ y $z$ por sus correspondientes variables extendidas en el dominio, $y_d$ y $z_d$.
...
\chapter{Computación estadística \label{cap:comp}}


\section{Estimación de los indicadores \label{sec:estindic}}

Para replicar el diseño muestral de la ECH y poder llevar a cabo el computo de los indicadores, se utiliza el software libre \textit{R}, más precisamente el paquete \textit{srvyr}. Este paquete utiliza las funciones del paquete \textit{survey} antes mencionado, permitiendo el uso de un estilo de sintaxis inspirado en el paquete \textit{dplyr}.

Este paquete \textit{srvyr} cuenta con funciones tales como $survey_mean$ para calcular medias o proporciones, $survey_ratio$ para ratios o $survey_total$ para totales. Estas funciones utilizan los ponderadores y dan como resultado tanto las estimaciones puntuales que correspondan como las estimaciones de los errores estándar, utilizando las ecuaciones y metodologías descritas en este documento para realizar los cálculos.

Para la estimación de los indicadores se crearon 9 funciones que varían dependiendo de los individuos involucrados (personas y hogares), la forma en la que se calcula cada indicador y las desagregaciones necesarias. Todas estas funciones estiman el indicador tanto a nivel de cada departamento como de todo el país y tienen como salida una tabla con los resultados.
...
La función 6 se utiliza unicamente para la estimación del indicador \textit{Promedio de años de educación de las personas de 25 años y más por sexo}. La variable en este caso es cuantitativa, se promedia y se desagrega por sexo.
...
Se crean además funciones para el cálculo de los intervalos de confianza de las estimaciones, 9 de ellas dan como salida una tabla con los extremos inferiores de los intervalos, mientras las otras 9 hacen lo mismo con los límites superiores.

\subsection{Listado de indicadores \label{subsec:lista}}

Los indicadores presentados en este trabajo son calculados todos los años por el Observatorio Territorio Uruguay (OTU) perteneciente a la Oficina de Planeamiento y Presupuesto (OPP), y se encuentran disponibles en su página oficial. Dentro de estos indicadores se encuentran algunos tales como tasas de actividad y de desempleo, tasas de asistencia en distintos niveles educativos, índices de pobreza, entre otros. A continuación se presenta un listado de los indicadores computados, haciendo referencia a que categoría pertenecen e indicando parte de la información necesaria para el cálculo de estos.
...
\begin{tabular}{rllllll}
 ...
 & Indicador & Categoría & Función & Variable & Desagregación & Base \\ 
  \hline
1 & Tasa de analfabetismo en población de 15 años o más & Educación & 1 & e48 & Dpto - Sexo  & Personas \\ 
  2 & Adolescentes de 12 a 17 años que asisten a establecimientos educativos & Educación & 1 & adol\_estudios & Dpto - Sexo  & Personas \\ 
  3 & Personas mayores de 15 años que completaron media básica general o técnica & Educación & 1 & e51\_4 & Dpto - Sexo  & Personas \\ 
  4 & Personas de 18 años o más que completaron segundo ciclo de educación media & Educación & 1 & secundaria\_utu2 & Dpto - Sexo  & Personas \\ 
  5 & Población entre 25 y 65 años con estudios terciarios & Educación & 1 & estudios\_terciarios & Dpto - Sexo  & Personas \\ 
  6 & Tasa neta de asistencia de 0 a 2 años en educación inicial & Educación & 1 & e238 & Dpto - Sexo  & Personas \\ 
  7 & Tasa neta de asistencia de 3 a 5 años en educación preescolar & Educación & 1 & e193 & Dpto - Sexo  & Personas \\ 
  8 & Tasa neta de asistencia de 6 a 11 años en educación primaria & Educación & 1 & e197 & Dpto - Sexo  & Personas \\ 
  9 & Tasa neta de asistencia de 12 a 17 años en educación media & Educación & 1 & edmedia & Dpto - Sexo  & Personas \\ 
  10 & Personas mayores a 25 años por máximo nivel educativo alcanzado & Educación & 2 & niveledu & Dpto - Sexo  & Personas \\ 
  11 & Ocupados por máximo nivel educativo alcanzado & Educación & 2 & niveledu & Dpto - Sexo & Personas \\ 
  12 & Tasa de analfabetismo en mayores de 15 años & Educación & 3 & e48 & Dpto - Tramos de edad  & Personas \\ 
  13 & Promedio de años de educación de las personas de 25 años o más & Educación & 6 & a\_estudio & Dpto - Sexo  & Personas \\ 
  14 & Tasa bruta de asistencia de 3 a 5 años en educación preescolar & Educación & 7 & e193 - e3a5 & Dpto & Personas \\ 
  15 & Tasa bruta de asistencia de 6 a 11 años en educación primaria & Educación & 7 & e197 - e6a11 & Dpto  & Personas \\ 
  16 & Tasa bruta de asistencia de 12 a 17 años en educación media & Educación & 7 & edmedia - e12a17 & Dpto  & Personas \\ 
  17 & Jóvenes de 14 a 24 años que no estudian ni trabajan & Educación / Mercado Laboral & 1 & nini & Dpto - Sexo  & Personas \\ 
  18 & Personas afiliadas a emergencias móviles & Salud & 1 & e46 & Dpto - Sexo  & Personas \\ 
  19 & Personas afiliadas a emergencias móviles & Salud & 4 & e46 & Dpto - Tramos de edad  & Personas \\ 
  20 & Personas por tipo de atención en salud & Salud & - & e45\_1 - e45\_2 - e45\_3 - e45\_4 - e45\_5 - e45\_6 - e45\_7 - no\_tiene & Dpto  & Personas \\ 
  45 & Población por lugar de nacimiento & Demografía & 2 & e37 & Dpto - Sexo  & Personas \\ 
  46 & Personas por lugar de residencia anterior & Demografía & 2 & e39 & Dpto - Sexo  & Personas \\ 
  47 & Población por lugar de residencia hace 5 años & Demografía & 2 & e236\_mod & Dpto - Sexo & Personas \\ 
  48 & Hogares por tipo de evacuación del sistema sanitario & Viviendas y hogares & 9 & d16 & Dpto  & Hogares \\ 
  49 & Hogares por presencia de lugar para cocinar & Viviendas y hogares & 9 & d19 & Dpto  & Hogares \\ 
  50 & Hogares por presencia y uso de baño & Viviendas y hogares & 9 & d15 & Dpto  & Hogares \\ 
  51 & Hogares por fuente de energía para iluminar & Viviendas y hogares & 9 & d18 & Dpto  & Hogares \\ 
  52 & Hogares por origen de agua para beber y cocinar & Viviendas y hogares & 9 & d11 & Dpto  & Hogares \\ 
  53 & Hogares por tipo de relación con la vivienda & Viviendas y hogares & - & propietarios - d8\_1 - Oc\_con\_permiso - d8\_1 & Dpto & Hogares \\ 
   \hline
\end{tabular}
\end{table}
...
Cabe aclarar que INE hizo pública esta información para el año 2019.
...
La barra lateral es utilizada para cargar las bases de datos y para seleccionar la sección que se desee visualizar, ya sea la pestaña de introducción o las correspondientes a las diferentes categorías de los indicadores. Para cargar los datos se utiliza la función \textit{fileInput} y se deben cargar por separadas las bases de personas y de hogares de la ECH y el archivo que contiene la información acerca de los estratos y UPMs (en caso de contar con el). También se incluye un widget mediante la función \textit{selectInput} para especificar si las bases utilizadas son las públicas o si se cuenta con la información de estratos y UPMs.

\begin{figure}[ht]
\begin{center}
\includegraphics[width=0.30\textwidth]{Barra_lateral.PNG}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=0.30\textwidth]{cat.PNG}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=0.30\textwidth]{pest.PNG}
...
En esta parte de la App se realizan todos los cálculos necesarios. En primer lugar se crean todos los elementos reactivos (se guardan las bases de datos cargadas, los diseños y todos los indicadores) utilizando la función \textit{reactive}. Luego se crean todos los componentes de salida con funciones render, las tablas con \textit{renderDT} y los gráficos con \textit{renderPlotly}. Tanto las tablas como los gráficos se crean en outputs diferentes para cada una de las categorías de indicadores.

\textit{Plotly} hace los gráficos interactivos, cuenta con varias opciones para poder visualizarlos de manera más precisa y permite descargarlos como imagen.

\chapter{Ejemplo de aplicación \label{cap:aplic}}

En esta sección se presenta el procedimiento aplicado y los resultados obtenidos para el caso de un indicador en particular, la tasa de desempleo por sexo. Utilizando la ECH del 2019 y la información sobre los estratos y unidades primarias de muestreo (UPM).

En primer lugar se cargan las bases de datos necesarias, disponibles en la página web del INE.

\begin{figure}[ht]
\begin{center}
\includegraphics[width=0.30\textwidth]{bases.PNG}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=1\textwidth]{indicador.png}
\caption{Selección del indicador. \label{ind}}
\end{center}
\end{figure}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=1\textwidth]{barras.PNG}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=1\textwidth]{Mapa.png}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=1\textwidth]{cat_mapa.PNG}
...
\begin{figure}[ht]
\includegraphics[width=1.2\textwidth]{inf.PNG}
...
\begin{figure}[ht]
\includegraphics[width=1.2\textwidth]{sup.PNG}
